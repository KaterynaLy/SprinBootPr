...
INSERT INTO `clinica_dental`.`paciente` (`nombre`, `apellido`, `email`, `telefono`, `direccion`, `fechaNacimiento`, `genero`, `origenCliente`)
VALUES 
...
INSERT INTO `clinica_dental`.`caja` (`fechaPago`, `monto`, `metodoPago`, `financiador`, `idPaciente`, `idFinanciacion`)
VALUES 
...
INSERT INTO `clinica_dental`.`tratamiento` (`descripcion`, `fechaInicio`, `fechaFin`, `idPaciente`, `nombre`, `presupuesto`, `aprobado`)
VALUES 
...
INSERT INTO `clinica_dental`.`documento` (`nombreDocumento`, `fechaFirma`, `idPaciente`, `firmado`, `idTratamiento`)
VALUES 
...
INSERT INTO `clinica_dental`.`presupuesto` (`descripcion`, `monto`, `fechaCreacion`, `fechaAceptacion`, `idPaciente`, `estado`)
VALUES 
...
INSERT INTO `clinica_dental`.`usuario` (`nombreUsuario`, `email`, `password`, `idRol`)
VALUES 
